...
document.getElementById("btn").onclick=addStudent;
...
function edit(id) {
    students.forEach((student) => {
        if (student['ID'] == id) {
            ...
            document.getElementById('btn').innerText = 'Edit Student';

            document.getElementById("btn").onclick = function jsFunc() {
    ...
    students.forEach((student) => {
        ...
        keys.forEach((key) => {
            if (key == 'ID') {
                ...
                </div> <div class="icons"><a onClick="edit(${student['ID']})" class="fa-regular fa-pen-to-square"></a> <a onClick="del(${student['ID']})" class="fa-solid fa-trash"></a> </div> `;  
